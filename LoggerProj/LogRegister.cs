    ...
    public class LogRegister
    {
        public static void Register(IServiceCollection services)
        {
            ...
            Log.Logger = new LoggerConfiguration() 
                ...
                .WriteTo.File("logs/log-.txt",Serilog.Events.LogEventLevel.Information, fileSizeLimitBytes: 1024, rollOnFileSizeLimit: true, rollingInterval: RollingInterval.Day) // bin/Debug/net8.0-windows/logs/ 下的按天滚动 txt 文件,eg:log-20260206.txt
                .CreateLogger();
